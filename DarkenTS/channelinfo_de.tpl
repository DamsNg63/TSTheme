...
<table id="info">
  <tr title="Position des Kanals: %%CHANNEL_ORDER%%"><td class="label" width="134">Kanalname:</td><td><a class="TextMessage_ChannelLink" href="channelid://%%CHANNEL_ID%%">%%CHANNEL_NAME%%</a></td></tr>
