...
<table id="info">
  <tr>
    ...
    <td><!--<img src="%%?CLIENT_COUNTRY_IMAGE%%" alt="" title="%%CLIENT_COUNTRY_TOOLTIP%%"/>&nbsp;&nbsp;--><a href="client://%%CLIENT_ID%%/%%CLIENT_UNIQUE_ID%%~%%CLIENT_NAME_PERCENT_ENCODED%%" class="TextMessage_UserLink">%%CLIENT_NAME%%</a></td>
  </tr>
  ...
  <tr><td class="label">Eindeutige ID:</td><td>%%CLIENT_UNIQUE_ID%%</td></tr>
<tr></tr>
  <tr title="%%CLIENT_VERSION%%"><td class="label" valign='bottom'>Version:</td><td>%%CLIENT_VERSION_SHORT%% %%CLIENT_VERSION_STATE%%</td></tr>
  <tr><td class="label">Plattform:</td><td>%%CLIENT_PLATFORM%% <!--<img src='gfx:DarkenTS/gui/platform/%%CLIENT_PLATFORM%%.png' alt=''/>--></td></tr>
<tr></tr>
  <tr><td class="label">Erste Verbindung:</td><td>%%CLIENT_CREATED%%</td></tr>
  <tr><td class="label">Letzte Verbindung:</td><td>%%CLIENT_LASTCONNECTED%% (verbunden seit %%CLIENT_CONNECTED_SINCE%%)</td></tr>
  <tr><td class="label">Verbindungen Total:</td><td>%%CLIENT_TOTALCONNECTIONS%%</td></tr>
<tr></tr>
  <tr>
