...
<table id="info">
  <tr title="Position des Kanals: %%CHANNEL_ORDER%%"><td class="label" width="134">Name:</td><td><a class="TextMessage_ChannelLink" href="channelid://%%CHANNEL_ID%%">%%CHANNEL_NAME%%</a></td></tr>
...
<tr></tr>
  ...
  <tr><td class="label">Abonnementstatus:</td><td>%%CHANNEL_SUBSCRIPTION%%</td></tr>
  <tr><td class="label">Sprachverschl&uuml;sselung:</td><td>%%CHANNEL_VOICE_DATA_ENCRYPTED%%</td></tr>
<tr></tr>
</table>

<table>
  <tr><td class="label" width="134">Ben&ouml;tigtes Rederecht:</td><td class="red" title="Fordere 'Talk Power' an um in diesem Channel sprechen zu können.">%%?CHANNEL_NEEDED_TALK_POWER%%<br /></td></tr>
</table> 
