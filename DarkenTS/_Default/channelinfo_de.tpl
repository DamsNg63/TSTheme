...
<table id="info">
  ...
  <tr><td class="label">Ben&ouml;tigtes Rederecht:</td><td class="red"><img src="iconpath:MODERATED?size=16x16" height="12" width="12" alt="" title="Fordere Rederechte an um in diesem Channel zu sprechen." />&nbsp;&nbsp;%%?CHANNEL_NEEDED_TALK_POWER%%</td></tr>
  <tr>
